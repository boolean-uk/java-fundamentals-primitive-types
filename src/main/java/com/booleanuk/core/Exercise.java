...
public class Exercise extends ExerciseBase {
    ...
    public String fullName = String.format("%s %s", this.firstName, this.lastName);

    // 11. Create a public char member named tenthLetter that contains the tenth letter in the alphabet member above.
    public char tenthLetter = this.alphabet.charAt(9);
    ...
    public String lowerAlphabet = this.alphabet.toLowerCase();
